...
public class NationalBankOfPups implements Observer,DisplayUnit{

	private String stockName;
	private float stockValue;
	private Subject centralStockRepository;
	
	public NationalBankOfPups(Subject centralStockRepository)
	{
	...
	public void display()
	{
		System.out.println("This is NationalBankOfPups. Top Stock data has been updated !");
